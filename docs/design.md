...
- 作成者: 木村英実（ecx Inc.）
- ステータス: **0.2.1 リリース準備中**（0.1.0 / 0.2.0 を公開済み）。API は 1.0.0 まで変更の可能性あり
- ライブラリ名: **Receipt html to pdf**
- npm パッケージ名: `@hidemikimura/receipt-html-to-pdf` — 0.1.0（2026-09-18）、0.2.0（2026-09-20、シャドウ DOM 対応・18 章）を公開済み
